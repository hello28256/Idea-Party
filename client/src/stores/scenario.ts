...
const SEED_SCENARIOS: Scenario[] = [
  {
    id: 'interview-coach',
    emoji: '🎤',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-interview-coach.jpg',
    title: '面试模拟',
  ...
  },
  {
    ...
    emoji: '💡',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-product-brainstorm.jpg',
    title: '产品头脑风暴',
...
- 如果 idea 太烂，直说，不要绕弯`,
  ...
  },
  {
    id: 'english-tutor',
    emoji: '🇬🇧',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-english-tutor.jpg',
    title: '英语陪练',
...
- Be patient but push me to use full sentences`,
  ...
  },
  {
    id: 'writing-coach',
    emoji: '✍️',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-writing-coach.jpg',
    title: '写作助手',
...
- 不要帮我重写，只指出方向`,
  ...
  },
  {
    id: 'socratic-coach',
    emoji: '🤔',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-socratic-coach.jpg',
    title: '苏格拉底式提问',
  ...
  },
  {
    id: 'thesis-defense',
    emoji: '🎓',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-thesis-defense.jpg',
    title: '论文答辩模拟',
...
- 给修改示例，不只给批评`,
  ...
  // ===== 职业发展（4 个新增）=====
  {
    ...
    emoji: '🤝',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-client-negotiation.jpg',
    title: '客户谈判',
...
- 保持真实商务感，不要表演戏剧化`,
  ...
  },
  {
    ...
    emoji: '💰',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-salary-negotiation.jpg',
    title: '薪资谈判',
...
- 不要轻易让步，每让一步要换我让一步`,
  ...
  },
  {
    ...
    emoji: '📊',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-performance-review.jpg',
    title: '绩效面谈',
...
- 全程专业、不情绪化`,
  ...
  },
  {
    id: 'startup-pitch',
    emoji: '🚀',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-startup-pitch.jpg',
    title: '创业路演',
...
- 如果我回答得好，你会有礼貌地追问一层，看是不是背的稿子`,
  ...
  // ===== 决策咨询（3 个新增）=====
  {
    ...
    emoji: '🏠',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-home-buying-advisor.jpg',
    title: '买房决策',
...
- 不会替你做决定，但会把决定背后的代价说清楚`,
  ...
  },
  {
    ...
    emoji: '🛋️',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-renovation-review.jpg',
    title: '装修评审',
...
- 不接受"我朋友家这样装很好看"这种理由`,
  ...
  },
  {
    ...
    emoji: '🔀',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-job-change-advisor.jpg',
    title: '跳槽决策',
...
- 不会催我赶紧决定，会说"这种事想清楚再动"`,
  ...
  // ===== 学习成长（3 个新增）=====
  {
    id: 'japanese-tutor',
    emoji: '🇯🇵',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-japanese-tutor.jpg',
    title: '日语陪练',
...
- Don't overuse keigo, but correct me when I should use it`,
  ...
  },
  {
    id: 'book-club',
    emoji: '📚',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-book-club.jpg',
    title: '读书会',
...
- 不接受"我觉得写得很好"这种空话，会追问到具体`,
  ...
  },
  {
    id: 'debate-coach',
    emoji: '⚔️',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-debate-coach.jpg',
    title: '辩论陪练',
...
- 复盘时友善但犀利`,
  ...
  },
  {
    id: 'teaching-tutor',
    emoji: '🎓',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-teaching-tutor.jpg',
    title: '学科辅导',
...
- 讲到激动处会用感叹号，但不失专业`,
  ...
  // ===== 创意生活（3 个新增）=====
  {
    id: 'travel-planner',
    emoji: '✈️',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-travel-planner.jpg',
    title: '旅行规划',
...
- 不会用"网红打卡"这种词，会说"本地人才去的地方"`,
  ...
  },
  {
    id: 'fitness-coach',
    emoji: '💪',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-fitness-coach.jpg',
    title: '健身咨询',
...
- 涉及伤病或极端需求会主动让我去看医生`,
  ...
  },
  {
    ...
    emoji: '🌱',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-mental-health-listener.jpg',
    title: '心理倾听',
...
- 不会说"我理解你"——会说"听起来这真的挺难的"`,
  ...
  // ===== 编程技术（2 个新增）=====
  {
    id: 'code-reviewer',
    emoji: '🧑‍💻',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-code-reviewer.jpg',
    title: '代码 Review',
...
- 不会替我重写代码，只指出方向`,
  ...
  },
  {
    id: 'coding-buddy',
    emoji: '👯',
    cover: 'https://idea-party-uploads.oss-cn-shenzhen.aliyuncs.com/uploads/avatars/scenarios/scn-coding-buddy.jpg',
    title: '编程搭子',
